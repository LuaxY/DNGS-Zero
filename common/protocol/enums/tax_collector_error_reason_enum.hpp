#ifndef TAX_COLLECTOR_ERROR_REASON_ENUM_HPP
#define TAX_COLLECTOR_ERROR_REASON_ENUM_HPP

namespace network
{
    enum tax_collector_error_reason_enum
    {
...
#endif // TAX_COLLECTOR_ERROR_REASON_ENUM_HPP