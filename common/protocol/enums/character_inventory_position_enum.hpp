#ifndef CHARACTER_INVENTORY_POSITION_ENUM_HPP
#define CHARACTER_INVENTORY_POSITION_ENUM_HPP

namespace network
{
    enum character_inventory_position_enum
    {
...
#endif // CHARACTER_INVENTORY_POSITION_ENUM_HPP