#ifndef SOCIAL_GROUP_CREATION_RESULT_ENUM_HPP
#define SOCIAL_GROUP_CREATION_RESULT_ENUM_HPP

namespace network
{
    enum social_group_creation_result_enum
    {
...
#endif // SOCIAL_GROUP_CREATION_RESULT_ENUM_HPP